...
| 28  | Концентрация заряда электрона                                         | $e(v) = e / V_e$                          | $-1,046855 \cdot 10^{27}$ Кл$\cdot$м$^{-3}$            |
...
| 52  | Электростатическое напряжение электрино в составе нейтрона | $\varphi_э = \varphi_n / (2n_э)$                                                      | $1,1745529 \times 10^{-3}$ В                |
...
| 72  | Магнитная постоянная                                        | $\mu_0 = 1 / (\varepsilon_0 v_0^2)$                                    | $1,3436188 \times 10^{-6}$ Гн$\cdot$м⁻¹      |
...
| 93  | Электродинамическая постоянная электрона-генератора                                | $\beta = 3\varphi r_0 / э R_n$                             | $4,6772342 \times 10^{22}$ Дж$\cdot$Кл⁻²          |
