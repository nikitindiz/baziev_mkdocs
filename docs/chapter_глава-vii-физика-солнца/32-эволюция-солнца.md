...
$$M_{\odot}' = m_{\odot} + m'(T_{\odot}) + M_{\pi} - m_{\hbar} - m_{\text{♇}} = 2.0982523 \cdot 10^{30} \text{ кг}$$
...
$$\Delta m_n = \mu_{\odot} \cdot \tau_1 = 6,2234 \cdot 10^{22} \text{ кг} = 3,4876 \cdot 10^{-8} \, M_{n\odot}$$
