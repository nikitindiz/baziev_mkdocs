...
$$\varphi_n = \frac{E_n}{n_э \cdot э} = \frac{E_n}{n_e \cdot e} = \frac{E_n}{n_{\text{э}} \cdot \text{э} + n_e \cdot e} = \frac{E_n}{\pm 4,8065676 \cdot 10^{-19} \text{ Кл}} = \pm 1.1361211 \cdot  10^6 \text{ В} = \text{Const}$$
...
$$\varphi_{э} = \frac{\varphi_{n}}{n_э} = 4.6982116 \cdot 10^{-3} \, \text{В} = \text{Const}$$
...
$$\varphi_e = \frac{-\varphi_{e}}{n_e} = -3.7870703 \cdot 10^{5} \text{ В} = \text{Const}$$
...
$$K = \varphi_{e} \cdot э \cdot n_{e} \cdot n_{э} = \varphi_{э} \cdot e \cdot n_{e} \cdot n_{э} = 5,4608428 \cdot 10^{-13} \text{ Дж} = \text{Const}$$
...
& \varepsilon_a = \frac{-5,7004131 \cdot 10^{-41}}{3,538788 \cdot 10^{-14} \text{ м}} = -1,6108376 \cdot 10^{-27} \text{ Дж}
\end{aligned}
$$
...
$$\varepsilon_{aU} = A_U \cdot \varepsilon_a = 238 \cdot \varepsilon_a = 3,8337934 \cdot 10^{-25} \text{ Дж}$$
...
$$k_a = \frac{5,4608428 \cdot 10^{-13}}{1,6108376 \cdot 10^{-27}} = 3,39000641 \cdot 10^{14}$$
...
$$\Delta m = \frac{Q}{\mathscr{P}} \cdot m_\text{э} = 7,8429862 \cdot 10^{-33} \text{ кг}$$
...
$$\Delta m(O) = \frac{\Delta m}{4} = 1,9607465 \cdot 10^{-33} \, \text{кг}$$
...
где <span data-db-key="1320" data-src="images/formula_inline_91_9_3.webp"> $\Delta m(O)$ </span> — дефект массы на один атом кислорода. Таким образом, дефект массы атома кислорода — это дефицит 286 электрино в его составе, которыми он расплатился за участие в процессе горения. Атомы кислорода после выхода из процесса не только уменьшились в массе, но в них изменилось соотношение зарядов, ибо излученные электрино унесли положительный заряд <span data-db-key="1321" data-src="images/formula_inline_91_9_56.webp"> $\Delta Z = 286 \cdot э$ </span> .
...
$$C_m = \frac{E_n}{m_n} = \frac{K}{m_n} = \frac{\sqrt{\hbar \cdot \nu_{ед} \cdot n_э \cdot n_e \cdot \varepsilon_{ед}}}{m_n} = \frac{\varphi_э \cdot э \cdot n_э \cdot n_e}{m_n}, \frac{Дж}{кг}$$
...
$$\varepsilon(\gamma) = \sqrt{\hbar \cdot f \cdot \tau_{ri} \cdot \nu_{\text{ед}} \cdot \varepsilon_{ед}} = 1,1928321 \cdot 10^{-24} \text{ Дж}$$
