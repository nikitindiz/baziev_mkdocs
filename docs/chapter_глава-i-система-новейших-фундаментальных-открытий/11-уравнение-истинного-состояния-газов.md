...
При тщательном исследовании этого соотношения выявилось, что ${R_{i}}$, в этом случае неявно содержит еще один коэффициент $\updelta_{i}$, довольно сложной природы:
